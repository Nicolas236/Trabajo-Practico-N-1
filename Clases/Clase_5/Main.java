...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Aca creo el objeto
        CuentaCorriente  Usuario1 = new CuentaCorriente (nombre_Titular,saldo_cuenta);
        ...
        switch (opcion){
            ...
            case 2: {
                ...
                Usuario1.getEngreso(retiro);
                break;
            }
            case 3: {
                //Muestra el saldo de la cuenta
                Usuario1.setSaldo_cuenta();
                break;
            }
            case 4: {
                //Muestra los datos del Usuario
                Usuario1.setIdentidad();
                break;
            }
            case 5: {
                ...
                //Aca creo el objeto
                CuentaCorriente  Usuario2 = new CuentaCorriente (nombre_Titular,saldo_cuenta);

                System.out.println("Ingrese el Monto que desea transferir");
                monto_trans =sc.nextInt();
                Usuario1.transferencia(monto_trans);
                Usuario2.reseptorTransferencia(monto_trans);
